(function() {
    ...
    function LocationDataTablesProfile($filter, $scope, DTOptionsBuilder, DTColumnBuilder, locationMeasurements, locationStorage, locationDataSource, locationDatePicker) {
        var vm = this;
        ...
        function getDailyLocationAverageData() {
            ...
            return locationMeasurements.getDailyAverageProfileMeasurements(locationId, parameterId, 0, fromDate, toDate)
        ...
        function getHighFrequencyLocationAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationMeasurements.getHighFrequencyAverageProfileMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function getHourlyLocationAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationMeasurements.getHourlyAverageProfileMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function initDailyLocationAverageTable() {
            ...
            vm.tableParameter.tables.locationAverageTable.dtColumns = [
                ...
                DTColumnBuilder.newColumn('depth').withTitle('Depth (m)'),
