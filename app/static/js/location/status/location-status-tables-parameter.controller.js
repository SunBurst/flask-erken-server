(function() {
    ...
    angular
        .module('app.location')
        .controller('LocationStatusTablesParameter', LocationStatusTablesParameter);
    
    LocationStatusTablesParameter.$inject = [
        '$filter',
        '$scope',        
        'DTOptionsBuilder', 
        'DTColumnBuilder',
    ...
    function LocationStatusTablesParameter($filter, $scope, DTOptionsBuilder, DTColumnBuilder, locationStatusMeasurements, locationStorage, locationDataSource, locationDatePicker) {
        var vm = this;
        ...
        function getDailyLocationAverageData() {
            ...
            return locationStatusMeasurements.getDailyAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
        ...
        function getDailyStationsAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationStatusMeasurements.getDailyStationsAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function getHighFrequencyLocationAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationStatusMeasurements.getHighFrequencyAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function getHighFrequencyStationsAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationStatusMeasurements.getHighFrequencyStationsAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function getHourlyLocationAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationStatusMeasurements.getHourlyAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
        ...
        function getHourlyStationsAverageData() {
            ...
            var fromDate = vm.datePickerModel.datePicker.date.startDate.valueOf();
            var toDate = vm.datePickerModel.datePicker.date.endDate.valueOf();
            return locationStatusMeasurements.getHourlyStationsAverageParameterMeasurements(locationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response;
                });
        }
