(function() {
    ...
    angular
        .module('app.station')
        .controller('StationDataTablesParameterCtrl', StationDataTablesParameterCtrl);
    
    StationDataTablesParameterCtrl.$inject = [
        '$filter',
        '$scope',        
    ...
    function StationDataTablesParameterCtrl($filter, $scope, DataTableParameterOptions, stationMeasurements, stationStorage, stationDataSource, stationDataTimeOptions) {
        var vm = this;
        ...
        function getDailyData() {
            ...
            return stationMeasurements.getDailySingleParameterMeasurements(stationId, parameterId, 0, fromDate, toDate)
        ...
        function getHighFrequencyData() {
            ...
            var fromDate = vm.datePickerModel.startDate.valueOf();
            var toDate = vm.datePickerModel.endDate.valueOf();
            return stationMeasurements.getHighFrequencySingleParameterMeasurements(stationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response.data;
                });
        }
        ...
        function getHourlyData() {
            ...
            var fromDate = vm.datePickerModel.startDate.valueOf();
            var toDate = vm.datePickerModel.endDate.valueOf();
            return stationMeasurements.getHourlySingleParameterMeasurements(stationId, parameterId, 0, fromDate, toDate)
                .then(function(response) {
                    return response.data;
                });
        }
